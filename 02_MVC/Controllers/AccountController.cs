...
namespace _02_MVC.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            // Intentar iniciar sesión usando el UserName proporcionado
            var result = await SignInManager.PasswordSignInAsync(model.UserName ?? "", model.Password, model.RememberMe, shouldLockout: false);
            if (result == SignInStatus.Failure && !string.IsNullOrEmpty(model.Email))
            {
                // Intentar iniciar sesión usando el email: buscar usuario por email y usar su UserName
